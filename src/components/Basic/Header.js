            ...
            <Navbar collapseOnSelect expand="sm" bg={THEME_COLOR} variant="dark">
                <Container>
                    ...
                    <Navbar.Collapse id="responsive-navbar-nav">
                        ...
                        <Nav>
                            <Nav.Link eventKey="4"><Link className="nav-link" to="/login">Login</Link></Nav.Link>
                            <NavDropdown title="My Account" id="collasible-nav-dropdown">
                                <Nav.Link eventKey="5"><Link className="dropdown-item" to="/profile">Profile</Link></Nav.Link>
                                <Nav.Link eventKey="6"><Link className="dropdown-item" to="/transaction">Transactions</Link></Nav.Link>
                                <NavDropdown.Divider />
                                <Nav.Link eventKey="7"><Link className="dropdown-item" to="/logout">Logout</Link></Nav.Link>
                            </NavDropdown>
                        </Nav>
                    </Navbar.Collapse>
